  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4013 4015
received: Send me a 4-byte message containing the signature you got from S.E.C.R.E.T in the first 4 bytes (in network byte order).
➜  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4044 4045
received: Greetings! I am E.X.P.S.T.N, which stands for "Enhanced X-link Port Storage Transaction Node".
...
➜  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4052 4053
timeout: no response
➜  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4052 4053
timeout: no response
➜  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4052 4053
...
➜  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4052 4053
timeout: no response
➜  udp-port-scanner git:(main) ✗ ./scanner <server_ip> 4081 4082
received: Greetings from S.E.C.R.E.T. (Secure Encryption Certification Relay with Enhanced Trust)! Here's how to access the secret port I'm safeguarding:
...
3. I will reply with a 5-byte message, where the first byte is your group ID and the remaining 4 bytes are a 32bit challenge number (in network byte order)
